...
public class Constants {
  ...
  public  static final String ROW_ID="id";
    ...
    //DB
   public static final String DB_NAME="CAL_DB";
     public static final String TB_NAME="CALTRACKER_TB";
    static final int DB_VERSION=1;

    //CREATE TB
    static final String CREATE_TB="CREATE TABLE CALTRACKER_TB(id INTEGER PRIMARY KEY AUTOINCREMENT,"
